...
DATASET_PATH = ''
DOCUMENTS_FILENAME = 'cran.all.1400'

DICTIONARY_FILENAME = 'cranfield_dictionary'
...
def compute():
    ...
    for document_id, filename in zip(filename_id_list, filename_list):
        word_list = document_words_list[document_id]
